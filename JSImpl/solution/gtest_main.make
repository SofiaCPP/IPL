...
ifeq ($(config),debug32)
  ...
  OBJRESP             =
  OBJECTS := \
	$(OBJDIR)/test/googletest/googletest/src/gtest_main.o \
...
$(OBJDIR)/test/googletest/googletest/src/gtest_main.o: ../test/googletest/googletest/src/gtest_main.cc $(GCH) $(MAKEFILE) | $(OBJDIR)/test/googletest/googletest/src
	@echo $(notdir $<)
