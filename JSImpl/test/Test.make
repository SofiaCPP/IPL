...
ifeq ($(config),debug)
  OBJDIR              = ../build/obj/Debug/Debug/Test
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"../build/bin/Debug" -L"."
...
ifeq ($(config),release)
  OBJDIR              = ../build/obj/Release/Release/Test
  ...
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS        += $(LDFLAGS) -L"../build/bin/Release" -L"."
