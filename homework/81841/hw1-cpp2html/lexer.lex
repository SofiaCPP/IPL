...
%%
//{literal_int}	    {return emit(LITERAL_NUMBER, yytext);}
//{literal_float}	    {return emit(LITERAL_NUMBER, yytext);}
//{literal_char}		{return emit(LITERAL_TEXT  , yytext);}
//{literal_text}		{return emit(LITERAL_TEXT  , yytext);}
